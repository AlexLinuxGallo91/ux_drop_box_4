...
MSG_OUTPUT_INGRESO_PAGINA_PRINCIPAL_SIN_EXITO = 'fue imposible ingresar principal de Drop Box: {}'

# inicio_sesion_claro_drive
MSG_OUTPUT_INICIO_SESION_EXITOSO = 'Se ingresa correctamente al portal Drop Box'
MSG_OUTPUT_INICIO_SESION_SIN_EXITO = 'fue imposible ingresar al portal Drop Box: {}'
